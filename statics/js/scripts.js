window.onscroll = function () {
    ...
    if (window.pageYOffset > content3 - 300) {
        ...
        var intervalTree = setInterval(function () {
            jQuery(jQuery(".treeOne").children()[i])
                .css("opacity", 1)
                .addClass("bounceInRight");
            i++;
    ...
    if (window.pageYOffset > content4 - 300) {
        ...
        var intervalTwo = setInterval(function () {
            jQuery(jQuery(".treeTwo").children()[j])
                .css("opacity", 1)
                .addClass("bounceInLeft");
            j++;
    ...
    if (window.pageYOffset > features2 - 300) {
        ...
        var intervalExt = setInterval(function () {
            jQuery(jQuery(".treeThree").children()[c])
                .css("opacity", 1)
                .addClass("flipInY");
            c++;
    ...
    if (window.pageYOffset > about3 - 300) {
        ...
        var intervalThree = setInterval(function () {
            jQuery(jQuery(".treeFour").children()[k])
                .css("opacity", 1)
                .addClass("bounceInLeft");
            k++;
    ...
    if (window.pageYOffset > content5 - 300) {
        ...
        var q = 0;
        var intervalThree = setInterval(function () {
            jQuery(jQuery(".treeEnd").children()[q])
                .css("opacity", 1)
                .addClass("bounceInRight");
            q++;
...
var itemsGalery = [
    {
        src: "/galery/i/photos/entrada1.jpeg",
        w: 346,
        h: 520
    },
    {
        src: "/galery/i/photos/entrada2.jpeg",
        w: 780,
        h: 520
    },
    {
    ...
    {
        src: "/rsc/img/terrace.jpeg",
        w: 346,
        h: 520
    },
    {
        src: "/rsc/img/terrace_back.jpeg",
        w: 720,
        h: 520
    },
];
